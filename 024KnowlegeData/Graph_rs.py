...
def graph_rs(year_string, opts_title_name) -> Graph:
    ...
    c = (
        ...
        .add(
            ...
            repulsion=50,
            linestyle_opts=opts.LineStyleOpts(width=0.1, color="source", curve=0.2),
...
def generate_json(year_string):
    ...
    #     print(item)
    # 生成categories信息
    categories_type = ['无线移动', '信息网络', '大数据与人工智能', '先进计算', '数字经济与法律监管', '两化融合与产业互联网', '网络安全与国际治理', 'ICT']
    ...
    categories_list = []
    temp_dict = {}
    for item_type in categories_rank_list:
        temp_dict["name"] = item_type[0]
...
if __name__ == "__main__":
    ...
    # 开始尝试tab选项卡多图的展示
    tab = Tab(page_title="十年院软课题知识网络拓扑图绘制(2010-2019)")
    ...
    tab.render("..\\000LocalData\\caict_k\\CAICT_rs_graph_circular.html")
