...
根据as_core_map_data_integrate数据，生成极坐标并绘图
...
def draw_polar_map(as_info, open_file, year_str):
    ...
    for line in file_read.readlines():
        ...
        if p1 and p2:
            ...
            if p1[1] < max_radius * 0.2 and p2[1] < max_radius * 0.2:
                line_width = 0.4
                line_color = line_color = [float(230/256), float(51/256), float(51/256)]
                alpha_value = 1
                z_order_value = 6
    ...
    # plt.xticks([])  # 去掉横坐标
    # plt.yticks([])  # 去掉纵坐标
    save_fig_name = "../000LocalData/as_compare/as_core_map_integrate" + year_str + ".jpg"
