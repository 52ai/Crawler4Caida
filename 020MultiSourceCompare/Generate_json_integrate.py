...
file_in = '..\\000LocalData\\as_compare\\as_core_map_data_integrate_20191203_rank.csv'
...
# 生成json
with open("../000LocalData/as_compare/as_rel20191203.json", "w") as f:
    json.dump(hjson, f)
