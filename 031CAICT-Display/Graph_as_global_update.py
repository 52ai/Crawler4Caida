# coding:utf-8
"""
create on May 21, 2020 By Wayne Yu

绘制全球AS网络互联关系-星云图，用于院大屏展示系统
如果条件允许，全球AS网络互联关系-星云图，亦可如中国AS网络互联关系拓扑互联一样自由发挥
"""
import json
import numpy as np
...
def read_as_info(file_name):
    ...
    as_list = []
    # 中日韩
    country_group = ["CN", "JP", "RU", "HK", "Others"]
...
def graph_weibo(title_name) -> Graph:
    ...
    file_in = '..\\000LocalData\\as_map\\as_core_map_data_new20190101.csv'
    bgp_file = "..\\000LocalData\\as_relationships\\serial-1\\20190101.as-rel.txt"
    ...
    c = (
        Graph(init_opts=opts.InitOpts(width="1553.78px", height="691.883px", page_title=title_name, theme=ThemeType.DARK, bg_color="#000"))
        .add(
            "",
            as_info_dict,
            as_links_dict,
