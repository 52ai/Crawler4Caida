...
1）全球BGP互联关系变化趋势（时间+统计值，包括All Relationships、Peer、Transit）
2）全球BGP互联关系数据量统计分布图（互联数量+统计值，无标度网络特征出现，后续再进一步研究）（直接绘制1998-2019）
3）全球各主要国家国内BGP互联关系变化趋势（时间+国内BGP互联关系数量）【另附文件】
4）全球各主要国家对外BGP互联关系变化趋势（时间+对外BGP互联关系数量）【另附文件】
5）代表性AS互联关系变化趋势（全球TOP AS 20、全国TOP AS 20，时间+BGP互联关系统计值5项）【另附文件】
6）我国出口AS互联关系统计（互联国家+互联关系总数）（直接绘制1998-2019）【另附文件】
