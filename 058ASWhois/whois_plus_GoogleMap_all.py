...
综合asns.csv文件
若AS Geo为空且该AS不是私有自治域网络号码，根据AS的whois信息，结合Google Map获取经纬度信息
"""
import csv
import time
# 实现无可视化界面
...
def gain_geo():
    ...
    for line in file_read.readlines():
        ...
        """
        with open("D:/Code/Crawler4Caida/058ASWhois/asns_google_all.csv", "a", newline='', encoding='utf-8') as csv_file:
            writer = csv.writer(csv_file, delimiter=',', quotechar='"')
