# coding:utf-8
"""
Create on June 18,2019 by Wayne
程序功能：
获取给定网站的截图和html源文件
...
def get_page_info(page_url, page_cnt):
    ...
    # 获取网站截图，并保存到本地
    driver.save_screenshot("../000LocalData/D010/website_"+str(page_cnt)+"_screen.png")
    # print(page_html)
    write_file_name = "../000LocalData/D010/website_"+str(page_cnt)+"_source.html"
...
if __name__ == "__main__":
    ...
    # 读取网站列表
    webList_file = "../000LocalData/D010/content.csv"
    ...
    mylog.append(log_str)
    # 输出程序运行日志
    log_file_name = "../000LocalData/D010/exe_log.log"
