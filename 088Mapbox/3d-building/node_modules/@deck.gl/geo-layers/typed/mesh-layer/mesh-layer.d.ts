...
export declare type MeshLayerProps<DataT = any> = _MeshLayerProps<DataT> & SimpleMeshLayerProps<DataT>;
...
export default class MeshLayer<DataT = any, ExtraProps = {}> extends SimpleMeshLayer<DataT, Required<_MeshLayerProps<DataT>> & ExtraProps> {
