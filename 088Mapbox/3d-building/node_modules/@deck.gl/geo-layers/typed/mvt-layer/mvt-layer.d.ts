...
export declare type MVTLayerProps<DataT extends Feature = Feature> = _MVTLayerProps & GeoJsonLayerProps<DataT> & TileLayerProps<ParsedMvtTile>;
...
export default class MVTLayer<DataT extends Feature = Feature, ExtraProps = {}> extends TileLayer<ParsedMvtTile, Required<_MVTLayerProps> & ExtraProps> {
    static layerName: string;
    static defaultProps: DefaultProps<MVTLayerProps<Feature<import("geojson").Geometry, import("geojson").GeoJsonProperties>>>;
