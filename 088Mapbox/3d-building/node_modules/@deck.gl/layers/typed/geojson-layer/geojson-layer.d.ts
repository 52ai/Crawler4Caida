...
export declare type GeoJsonLayerProps<DataT extends Feature = Feature> = _GeoJsonLayerProps<DataT> & CompositeLayerProps<DataT>;
...
export declare type _GeoJsonLayerProps<DataT extends Feature = Feature> = {
     ...
     */
    pointType?: string;
} & _GeoJsonLayerFillProps<DataT> & _GeoJsonLayerStrokeProps<DataT> & _GeoJsonLayer3DProps<DataT> & _GeoJsonLayerPointCircleProps<DataT> & _GeojsonLayerIconPointProps<DataT> & _GeojsonLayerTextPointProps<DataT>;
...
export default class GeoJsonLayer<DataT extends Feature = Feature, ExtraProps = {}> extends CompositeLayer<Required<GeoJsonLayerProps<DataT>> & ExtraProps> {
    static layerName: string;
    static defaultProps: DefaultProps<GeoJsonLayerProps<Feature<import("geojson").Geometry, import("geojson").GeoJsonProperties>>>;
