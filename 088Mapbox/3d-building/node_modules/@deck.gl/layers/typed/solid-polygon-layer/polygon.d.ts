 ...
 */
export declare function normalize(polygon: PolygonGeometry, positionSize: number): NormalizedPolygonGeometry;
export declare function getSurfaceIndices(polygon: NormalizedPolygonGeometry, positionSize: number, preproject?: (xy: number[]) => number[]): number[];
