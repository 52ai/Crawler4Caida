...
import type { LayerProps, Color, Material, Accessor, AccessorFunction, UpdateParameters, GetPickingInfoParams, PickingInfo, DefaultProps } from '@deck.gl/core/typed';
...
export declare type SolidPolygonLayerProps<DataT = any> = _SolidPolygonLayerProps<DataT> & LayerProps<DataT>;
export default class SolidPolygonLayer<DataT = any, ExtraPropsT = {}> extends Layer<ExtraPropsT & Required<_SolidPolygonLayerProps<DataT>>> {
