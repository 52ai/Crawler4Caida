import { Layer, LayerProps, UpdateParameters, Unit, AccessorFunction, Position, Accessor, Color, Material, DefaultProps } from '@deck.gl/core/typed';
import { Model } from '@luma.gl/core';
/** All properties supported by PointCloudLayer. */
export declare type PointCloudLayerProps<DataT = any> = _PointCloudLayerProps<DataT> & LayerProps<DataT>;
...
export default class PointCloudLayer<DataT = any, ExtraPropsT = {}> extends Layer<ExtraPropsT & Required<_PointCloudLayerProps<DataT>>> {
