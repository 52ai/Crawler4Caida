...
export default class ColumnLayer<DataT = any, ExtraPropsT = {}> extends Layer<ExtraPropsT & Required<_ColumnLayerProps<DataT>>> {
    ...
    getGeometry(diskResolution: number, vertices: number[] | undefined, hasThinkness: boolean): ColumnGeometry;
