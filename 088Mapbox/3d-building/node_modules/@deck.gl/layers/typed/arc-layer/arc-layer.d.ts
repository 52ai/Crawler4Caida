import { Layer, UpdateParameters, LayerProps, Unit, AccessorFunction, Position, Accessor, Color, DefaultProps } from '@deck.gl/core/typed';
...
export default class ArcLayer<DataT = any, ExtraPropsT = {}> extends Layer<ExtraPropsT & Required<_ArcLayerProps<DataT>>> {
