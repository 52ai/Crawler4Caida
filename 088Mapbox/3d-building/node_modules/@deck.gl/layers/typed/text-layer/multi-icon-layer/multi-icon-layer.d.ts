...
import type { Accessor, Color, UpdateParameters, DefaultProps } from '@deck.gl/core/typed';
...
export declare type MultiIconLayerProps<DataT = any> = _MultiIconLayerProps<DataT> & IconLayerProps<DataT>;
export default class MultiIconLayer<DataT, ExtraPropsT = {}> extends IconLayer<DataT, ExtraPropsT & Required<_MultiIconLayerProps<DataT>>> {
