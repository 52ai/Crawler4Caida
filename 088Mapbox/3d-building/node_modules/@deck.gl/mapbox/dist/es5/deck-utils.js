...
function getDeckInstance(_ref) {
  ...
  var deckProps = {
    ...
    _customRender: function _customRender(reason) {
      map.triggerRepaint();
      customRender === null || customRender === void 0 ? void 0 : customRender(reason);
    },
    parameters: {
      depthMask: true,
      depthTest: true,
    ...
    views: deck && deck.props.views || [new _core.MapView({
      id: 'mapbox'
    })]
  };
  var deckInstance;
