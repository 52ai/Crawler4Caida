import { CompositeLayer, AttributeManager, UpdateParameters, CompositeLayerProps } from '@deck.gl/core/typed';
export declare type AggregationLayerProps<DataT = any> = CompositeLayerProps<DataT>;
export default abstract class AggregationLayer<ExtraPropsT = {}> extends CompositeLayer<ExtraPropsT> {
     ...
     **/
    isAttributeChanged(name?: string): any;
