...
/** @ignore */ declare type RecordBatchReaders<T extends {
    [key: string]: DataType;
} = any> = RecordBatchFileReader<T> | RecordBatchStreamReader<T>;
/** @ignore */ declare type AsyncRecordBatchReaders<T extends {
    [key: string]: DataType;
} = any> = AsyncRecordBatchFileReader<T> | AsyncRecordBatchStreamReader<T>;
/** @ignore */ declare type RecordBatchFileReaders<T extends {
    [key: string]: DataType;
} = any> = RecordBatchFileReader<T> | AsyncRecordBatchFileReader<T>;
/** @ignore */ declare type RecordBatchStreamReaders<T extends {
    [key: string]: DataType;
} = any> = RecordBatchStreamReader<T> | AsyncRecordBatchStreamReader<T>;
export declare class RecordBatchReader<T extends {
    [key: string]: DataType;
    ...
    static throughDOM<T extends {
        [key: string]: DataType;
    }>(writableStrategy?: ByteLengthQueuingStrategy, readableStrategy?: {
        autoDestroy: boolean;
    }): {
    ...
    static from<T extends {
        [key: string]: DataType;
    } = any>(source: FromArg4): Promise<RecordBatchFileReader<T> | AsyncRecordBatchReaders<T>>;
    static from<T extends {
        [key: string]: DataType;
    ...
    static readAll<T extends {
        [key: string]: DataType;
    } = any>(source: FromArg0): IterableIterator<RecordBatchStreamReader<T>>;
    static readAll<T extends {
        [key: string]: DataType;
    } = any>(source: FromArg1): AsyncIterableIterator<RecordBatchStreamReader<T>>;
    static readAll<T extends {
        [key: string]: DataType;
    } = any>(source: FromArg2): IterableIterator<RecordBatchFileReader<T> | RecordBatchStreamReader<T>>;
    static readAll<T extends {
        [key: string]: DataType;
    } = any>(source: FromArg3): AsyncIterableIterator<RecordBatchFileReader<T> | RecordBatchStreamReader<T>>;
    static readAll<T extends {
        [key: string]: DataType;
    } = any>(source: FromArg4): AsyncIterableIterator<RecordBatchFileReader<T> | AsyncRecordBatchReaders<T>>;
    static readAll<T extends {
        [key: string]: DataType;
    } = any>(source: FromArg5): AsyncIterableIterator<AsyncRecordBatchFileReader<T> | AsyncRecordBatchStreamReader<T>>;
}
/** @ignore */
...
/** @ignore */
declare type RecordBatchReaderImpls<T extends {
    [key: string]: DataType;
} = any> = RecordBatchJSONReaderImpl<T> | RecordBatchFileReaderImpl<T> | RecordBatchStreamReaderImpl<T> | AsyncRecordBatchFileReaderImpl<T> | AsyncRecordBatchStreamReaderImpl<T>;
/** @ignore */
interface RecordBatchReaderImpl<T extends {
    [key: string]: DataType;
} = any> {
    closed: boolean;
    schema: Schema<T>;
...
/** @ignore */
interface RecordBatchStreamReaderImpl<T extends {
    [key: string]: DataType;
} = any> extends RecordBatchReaderImpl<T> {
...
/** @ignore */
interface AsyncRecordBatchStreamReaderImpl<T extends {
    [key: string]: DataType;
} = any> extends RecordBatchReaderImpl<T> {
...
/** @ignore */
interface RecordBatchFileReaderImpl<T extends {
    [key: string]: DataType;
} = any> extends RecordBatchStreamReaderImpl<T> {
    readRecordBatch(index: number): RecordBatch<T> | null;
}
/** @ignore */
interface AsyncRecordBatchFileReaderImpl<T extends {
    [key: string]: DataType;
} = any> extends AsyncRecordBatchStreamReaderImpl<T> {
    readRecordBatch(index: number): Promise<RecordBatch<T> | null>;
}
/** @ignore */
...
declare class RecordBatchStreamReaderImpl<T extends {
    [key: string]: DataType;
} = any> extends RecordBatchReaderImpl<T> implements IterableIterator<RecordBatch<T>> {
...
declare class AsyncRecordBatchStreamReaderImpl<T extends {
    [key: string]: DataType;
} = any> extends RecordBatchReaderImpl<T> implements AsyncIterableIterator<RecordBatch<T>> {
...
declare class AsyncRecordBatchFileReaderImpl<T extends {
    [key: string]: DataType;
} = any> extends AsyncRecordBatchStreamReaderImpl<T> implements AsyncRecordBatchFileReaderImpl<T> {
    protected _footer?: Footer;
...
/** @ignore */
declare class RecordBatchJSONReaderImpl<T extends {
    [key: string]: DataType;
} = any> extends RecordBatchStreamReaderImpl<T> {
