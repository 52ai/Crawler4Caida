...
const decoder = new (typeof TextDecoder !== 'undefined' ? TextDecoder : text_encoding_utf_8_1.TextDecoder)('utf-8');
/** @ignore */
exports.decodeUtf8 = (buffer) => decoder.decode(buffer);
const encoder = new (typeof TextEncoder !== 'undefined' ? TextEncoder : text_encoding_utf_8_1.TextEncoder)();
/** @ignore */
