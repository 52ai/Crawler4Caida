...
const managed_array_1 = __importDefault(require("../../utils/managed-array"));
...
class TilesetTraverser {
    ...
    constructor(options) {
        ...
        this._traversalStack = new managed_array_1.default();
        this._emptyTraversalStack = new managed_array_1.default();
