...
# 配置全局的路径信息
sites_file = "../000LocalData/IPv6UrlCrawler/test2site/site"
result_dir = "../000LocalData/IPv6UrlCrawler/test2site/"
...
def gain_website_url(site_url):
    ...
    driver.get(site_url)
    time.sleep(3)  # 延迟加载，等待页面加载完毕
    site_url = driver.current_url  # 获取跳转之后的网络链接
    print("跳转后:", site_url)
...
if __name__ == "__main__":
    ...
    for site_item in site_list:
        ...
        save_path = result_dir + site_item_str + ".csv"
