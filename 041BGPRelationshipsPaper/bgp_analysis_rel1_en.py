...
def draw(draw_date, data_list):
    ...
    print(data_list)
    # 存储绘图数据
    save_path_data_list = "../000LocalData/Paper_Data/draw_rel1.csv"
    ...
    ax.grid(True)
    fig.tight_layout()
    save_path_fig = "..\\000LocalData\\Paper_Data\\draw_rel1_en.svg"
    plt.savefig(save_path_fig, dpi=600)
    save_path_fig = "..\\000LocalData\\Paper_Data\\draw_rel1_en.pdf"
    plt.savefig(save_path_fig, dpi=600)
    # plt.show()
