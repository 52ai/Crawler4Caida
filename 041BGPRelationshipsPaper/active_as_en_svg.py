# coding: utf-8
"""
create on July 6, 2020 by Wayne Yu
Function:
...
def draw(x_list, y_list, save_name):
    ...
    ax.grid(True)
    fig.tight_layout()
    save_fig_name = "../000LocalData/Paper_Data/" + save_name + "_en.svg"
    plt.savefig(save_fig_name, dpi=600)
    save_fig_name = "../000LocalData/Paper_Data/" + save_name + "_en.pdf"
    plt.savefig(save_fig_name, dpi=600)
    save_fig_name = "../000LocalData/Paper_Data/" + save_name + "_en.eps"
    plt.savefig(save_fig_name, dpi=600)
    # plt.show()
