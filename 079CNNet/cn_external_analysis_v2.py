...
def external_as_analysis(aim_country):
    ...
    big_three_org = ["China Telecom", "China Unicom", "CHINA UNICOM Industrial Internet Backbone", "China Mobile"]
    ...
    for path_item in file_path[-1:]:
        ...
        for line in file_read.readlines():
            ...
            try:
                ...
                if as2org[left_as] in big_three_org:
                    if as2country[right_as] != aim_country:
                        external_cnt += 1
                        external_as_list.append(left_as)
                        external_country_list.append(as2country[right_as])
                        external_country_as.append(right_as)

                        if as2org[left_as] == "China Telecom":
                            ct_2abroad_as.append(right_as)
                            ct_2abroad_org.append(as2org[right_as])
                            ct_as.append(left_as)

                        if as2org[left_as] == "China Unicom" or as2org[left_as] == "CHINA UNICOM Industrial Internet Backbone":
                            cu_2abroad_as.append(right_as)
                            cu_2abroad_org.append(as2org[right_as])
                            cu_as.append(left_as)

                        if as2org[left_as] == "China Mobile":
                            cm_2abroad_as.append(right_as)
                            cm_2abroad_org.append(as2org[right_as])
                            cm_as.append(left_as)

                if as2country[left_as] != aim_country:
                    if as2org[right_as] in big_three_org:
                        external_cnt += 1
                        external_as_list.append(right_as)
                        external_country_list.append(as2country[left_as])
                        external_country_as.append(left_as)

                        # print(as2org[right_as])
                        if as2org[right_as] == "China Telecom":
                            ct_2abroad_as.append(left_as)
                            ct_2abroad_org.append(as2org[left_as])
                            ct_as.append(right_as)

                        if as2org[right_as] == "China Unicom" or as2org[right_as] == "CHINA UNICOM Industrial Internet Backbone":
                            cu_2abroad_as.append(left_as)
                            cu_2abroad_org.append(as2org[left_as])
                            cu_as.append(right_as)

                        if as2org[right_as] == "China Mobile":
                            cm_2abroad_as.append(left_as)
                            cm_2abroad_org.append(as2org[left_as])
                            cm_as.append(right_as)

            except Exception as e:
                except_info.append(e)

        print("- - - -中国电信 - - - - - ")
        print("CT AS:", len(list(set(ct_as))))
        print(list(set(ct_as)))
        print("CT 2 Abroad AS:", len(list(set(ct_2abroad_as))))
        print("CT 2 Abroad Org:", len(list(set(ct_2abroad_org))))

        print("- - - -中国联通- - - - - ")
        print("CU AS:", len(list(set(cu_as))))
        print(list(set(cu_as)))
        print("CU 2 Abroad AS:", len(list(set(cu_2abroad_as))))
        print("CU 2 Abroad Org:", len(list(set(cu_2abroad_org))))

        print("- - - -中国移动- - - - - ")
        print("CM AS:", len(list(set(cm_as))))
        print(list(set(cm_as)))
