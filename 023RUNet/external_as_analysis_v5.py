# coding:utf-8
"""
create on Feb 14, 2020 By Wayne YU
...
def external_as_analysis(country, country_as_info, as2country):
    ...
    for path_item in file_path[-1:]:
        ...
        # print(external_country_rank_list)
        gain_external_country_rank_list_plus(external_country_rank_list, country)
        draw_bar(external_country_rank_list, country)


def gain_external_country_rank_list_plus(rank_list, country):
    """
    ...
    # 将信息存储到文件中
    save_path = "..\\000LocalData\\RUNet\\External_BGP_Rel" + country + "-ISP(20200201).csv"
...
def draw_bar(rank_list, country):
    ...
    # plt.show()
    plt.savefig("..\\000LocalData\\RUNet\\External_BGP_Rel" + country + "-ISP(20200201).jpg")
...
def external_as_analysis_topn(topn, country, country_as_info, as2country, as_info_topn):
    ...
    for path_item in file_path[-1:]:
        ...
        print("<TOP %s AS>External Edges  （JP）: %s, %f%%" % (topn, external_country_rank["JP"], float(external_country_rank["JP"] / top_n_external_cnt) * 100))
