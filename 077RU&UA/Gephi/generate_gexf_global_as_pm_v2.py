...
global_as_gephi_file = "D:/Code/Crawler4Caida/086LearnNodeJs/pm/own_graph/global_as_Global_new.gexf"
...
def generate_gephi_file():
    ...
    with open(asns_file, "r", encoding="utf-8") as f:
        for line in f.readlines():
            ...
            long = line[3]
            lat = line[4]
            # node_id = "AS" + line[0] + "-" + node_org + "-" + node_country
