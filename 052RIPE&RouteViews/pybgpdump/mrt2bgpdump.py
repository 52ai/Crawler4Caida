# coding:utf-8
"""
create on Sep 14, 2020 By Wenyan YU
Email: ieeflsyu@outlook.com
Function:
基于mrtparse库的样例程序mrt2bgpdump.py，按照CN-BGPMon系统要求进行修改
跨平台读取MRT格式的，并按照固定格式实时入库。
...
def main():
    mrt_updates = "../../000LocalData/BGPData/ripe/live_data/rrc00/updates.20200917.0835.gz"
