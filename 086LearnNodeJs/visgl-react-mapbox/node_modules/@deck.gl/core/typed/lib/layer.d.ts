...
export default abstract class Layer<PropsT = {}> extends Component<PropsT & Required<LayerProps>> {
    ...
    projectPosition(xyz: number[], params?: {
        /** The viewport to use */
        viewport?: Viewport;
    ...
    protected calculateInstancePickingColors(attribute: Attribute, { numInstances }: {
        numInstances: number;
    }): void;
    /** Apply changed attributes to  */
    protected _setModelAttributes(model: Model, changedAttributes: {
        [id: string]: Attribute;
    }): void;
    ...
    _finalize(): void;
    _drawLayer({ moduleParameters, uniforms, parameters }: {
