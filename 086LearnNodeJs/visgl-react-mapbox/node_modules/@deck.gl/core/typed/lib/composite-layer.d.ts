...
export default abstract class CompositeLayer<PropsT = {}> extends Layer<PropsT & Required<CompositeLayerProps>> {
    ...
    protected getSubLayerClass<T extends Layer>(subLayerId: string, DefaultLayerClass: ConstructorOf<T>): ConstructorOf<T>;
