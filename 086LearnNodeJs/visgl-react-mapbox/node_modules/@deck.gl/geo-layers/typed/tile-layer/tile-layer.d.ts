import { CompositeLayer, CompositeLayerProps, Layer, LayerProps, UpdateParameters, PickingInfo, GetPickingInfoParams, FilterContext } from '@deck.gl/core/typed';
 ...
 */
export default class TileLayer<DataT = any, ExtraPropsT = {}> extends CompositeLayer<ExtraPropsT & Required<_TileLayerProps<DataT>>> {
