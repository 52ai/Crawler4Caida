...
import { CustomMarkersRange, MapDataset, MapTextSubLayerConfig, TextLabel, VisConfig, VisualChannelField, VisualChannels } from './types';
...
export declare function getIconUrlAccessor(field: VisualChannelField | null | undefined, fallbackUrl: string | null | undefined, range: CustomMarkersRange | null | undefined, maxIconSize: number, data: any): any;
...
export declare function getTextPixelOffsetAccessor({ alignment, anchor, size }: TextLabel, radius: any): Accessor<unknown, [number, number]>;
