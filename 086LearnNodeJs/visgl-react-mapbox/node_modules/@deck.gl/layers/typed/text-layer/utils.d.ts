 ...
 */
export declare function buildMapping({ characterSet, getFontWidth, fontHeight, buffer, maxCanvasWidth, mapping, xOffset, yOffset }: {
    /** list of characters */
 ...
 */
export declare function autoWrapping(text: string[], wordBreak: 'break-all' | 'break-word', maxWidth: number, iconMapping: CharacterMapping, startIndex: number | undefined, endIndex: number): number[];
/**
 * Transform a text paragraph to an array of characters, each character contains
 */
export declare function transformParagraph(paragraph: string, 
/** CSS line-height */
lineHeight: number, 
...
export declare function getTextFromBuffer({ value, length, stride, offset, startIndices, characterSet }: {
