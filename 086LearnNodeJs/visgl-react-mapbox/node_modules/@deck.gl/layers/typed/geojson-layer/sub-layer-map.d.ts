...
export declare function getDefaultProps({ type, props }: {
    type: typeof Layer;
    props: Record<string, string>;
}): Record<string, any>;
export declare function forwardProps(layer: CompositeLayer, mapping: Record<string, string>): Record<string, any>;
