import { Accessor, AccessorFunction, Color, CompositeLayer, CompositeLayerProps, Layer, LayersList, Unit, Material, UpdateParameters, DefaultProps } from '@deck.gl/core/typed';
/**
 * All properties supported by `PolygonLayer`.
 */
export declare type PolygonLayerProps<DataT = any> = _PolygonLayerProps<DataT> & CompositeLayerProps<DataT>;
/**
...
export default class PolygonLayer<DataT = any, ExtraProps = {}> extends CompositeLayer<Required<_PolygonLayerProps<DataT>> & ExtraProps> {
