import { Layer, LayerProps, Unit, Position, Accessor, Color, UpdateParameters, DefaultProps } from '@deck.gl/core/typed';
 ...
 */
export default class LineLayer<DataT = any, ExtraProps = {}> extends Layer<ExtraProps & Required<_LineLayerProps<DataT>>> {
