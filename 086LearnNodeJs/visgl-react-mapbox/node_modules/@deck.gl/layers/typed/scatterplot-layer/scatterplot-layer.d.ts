...
import type { LayerProps, UpdateParameters, Accessor, Unit, Position, Color, DefaultProps } from '@deck.gl/core/typed';
/** All props supported by the ScatterplotLayer */
export declare type ScatterplotLayerProps<DataT = any> = _ScatterplotLayerProps<DataT> & LayerProps<DataT>;
...
export default class ScatterplotLayer<DataT = any, ExtraPropsT = {}> extends Layer<ExtraPropsT & Required<_ScatterplotLayerProps<DataT>>> {
