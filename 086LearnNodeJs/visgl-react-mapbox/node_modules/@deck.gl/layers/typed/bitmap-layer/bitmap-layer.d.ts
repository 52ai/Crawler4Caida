import { Layer, CoordinateSystem, LayerProps, PickingInfo, GetPickingInfoParams, UpdateParameters, Color, Texture, Position, DefaultProps } from '@deck.gl/core/typed';
...
export default class BitmapLayer<ExtraPropsT = {}> extends Layer<ExtraPropsT & Required<_BitmapLayerProps>> {
