...
import type { LayerProps, Color, Accessor, AccessorFunction, Unit, UpdateParameters, GetPickingInfoParams, PickingInfo, DefaultProps } from '@deck.gl/core/typed';
...
export default class PathLayer<DataT = any, ExtraPropsT = {}> extends Layer<ExtraPropsT & Required<_PathLayerProps<DataT>>> {
