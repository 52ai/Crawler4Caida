import { CompositeLayer, CompositeLayerProps, Layer, UpdateParameters, DefaultProps } from '@deck.gl/core/typed';
...
export declare type GridLayerProps<DataT = any> = _GridLayerProps<DataT> & CompositeLayerProps<DataT>;
/** Properties added by GridLayer. */
declare type _GridLayerProps<DataT> = _CPUGridLayerProps<DataT> & _GPUGridLayerProps<DataT> & {
    /**
...
export default class GridLayer<DataT = any, ExtraPropsT = {}> extends CompositeLayer<ExtraPropsT & Required<_GridLayerProps<DataT>>> {
