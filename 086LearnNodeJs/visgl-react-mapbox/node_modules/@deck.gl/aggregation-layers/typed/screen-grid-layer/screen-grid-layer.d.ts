import { Accessor, Color, GetPickingInfoParams, Layer, LayerContext, LayersList, PickingInfo, Position, UpdateParameters, DefaultProps } from '@deck.gl/core/typed';
...
export declare type ScreenGridLayerProps<DataT = any> = _ScreenGridLayerProps<DataT> & GridAggregationLayerProps<DataT>;
...
export default class ScreenGridLayer<DataT = any, ExtraProps = {}> extends GridAggregationLayer<ExtraProps & Required<_ScreenGridLayerProps<DataT>>> {
