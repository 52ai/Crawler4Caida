...
import { Layer, LayerProps, UpdateParameters } from '@deck.gl/core/typed';
import type { _ScreenGridLayerProps } from './screen-grid-layer';
/** All properties supported by ScreenGridCellLayer. */
export declare type ScreenGridCellLayerProps<DataT = any> = _ScreenGridCellLayerProps<DataT> & LayerProps<DataT>;
...
export default class ScreenGridCellLayer<DataT = any, ExtraPropsT = {}> extends Layer<ExtraPropsT & Required<_ScreenGridCellLayerProps<DataT>>> {
