...
export default class BinSorter {
    ...
    constructor(bins?: never[], props?: Partial<typeof defaultProps>);
    /**
    ...
    getValueDomainByScale(scale: string, [lower, upper]?: [(number | undefined)?, (number | undefined)?]): [number, number] | never[];
