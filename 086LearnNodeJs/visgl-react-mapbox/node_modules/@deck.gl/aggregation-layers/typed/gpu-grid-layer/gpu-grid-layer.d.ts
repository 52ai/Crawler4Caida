import { Accessor, AccessorFunction, Color, Material, GetPickingInfoParams, LayerContext, PickingInfo, Position, DefaultProps } from '@deck.gl/core/typed';
...
export declare type GPUGridLayerProps<DataT = any> = _GPUGridLayerProps<DataT> & GridAggregationLayerProps<DataT>;
...
export default class GPUGridLayer<DataT = any, ExtraPropsT = {}> extends GridAggregationLayer<ExtraPropsT & Required<_GPUGridLayerProps<DataT>>> {
    ...
    renderLayers(): GPUGridCellLayer | null;
