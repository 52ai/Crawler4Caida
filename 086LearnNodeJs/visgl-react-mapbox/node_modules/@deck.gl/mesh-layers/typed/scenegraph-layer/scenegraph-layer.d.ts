...
import type { UpdateParameters, LayerContext, LayerProps, Position, Color, Accessor, DefaultProps } from '@deck.gl/core/typed';
export declare type ScenegraphLayerProps<DataT = any> = _ScenegraphLayerProps<DataT> & LayerProps<DataT>;
declare type _ScenegraphLayerProps<DataT> = {
     ...
     */
    _imageBasedLightingEnvironment?: null | GLTFEnvironment | ((context: {
        gl: WebGLRenderingContext;
        layer: ScenegraphLayer<DataT>;
    }) => GLTFEnvironment);
...
export default class ScenegraphLayer<DataT = any, ExtraPropsT = {}> extends Layer<ExtraPropsT & Required<_ScenegraphLayerProps<DataT>>> {
    ...
    draw({ moduleParameters, parameters, context }: {
        moduleParameters?: null | undefined;
