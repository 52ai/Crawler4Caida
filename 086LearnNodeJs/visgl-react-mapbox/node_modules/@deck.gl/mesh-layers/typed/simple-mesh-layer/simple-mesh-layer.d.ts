...
import type { LayerProps, UpdateParameters, Accessor, Position, Color, Texture } from '@deck.gl/core/typed';
import type { MeshAttribute, MeshAttributes } from '@loaders.gl/schema';
import type { Geometry as GeometryType } from '@luma.gl/engine';
import { GLTFMaterialParser } from '@luma.gl/experimental';
declare type Mesh = GeometryType | {
...
export declare type SimpleMeshLayerProps<DataT = any> = _SimpleMeshLayerProps<DataT> & LayerProps<DataT>;
/** Render a number of instances of an arbitrary 3D geometry. */
export default class SimpleMeshLayer<DataT = any, ExtraPropsT = {}> extends Layer<ExtraPropsT & Required<_SimpleMeshLayerProps<DataT>>> {
