    ...
    return (
      <div className='container'>
        ...
        <div className='media-list'>
               ...
               <Destination description='全球互联网星际巡航图，汇聚全球自治域网络及其互联关系'
                  href='#/galaxy/my-graph'
                  media='bower_fly_first.png'
                  name='Global'/>

              <Destination description='中国互联网星域'
          href='#/galaxy/cn'
          media='composer_fly_first.png'
          name='CN'/>

          <Destination description='美国互联网星域'
                      href='#/galaxy/us'
                      media='ruby_fly_first.png'
                      name='US'/>

          <Destination description='德国互联网星域'
                      href='#/galaxy/de'
                      media='npm_fly_first.png'
                      name='DE'/>

          <Destination description='俄罗斯互联网星域'
                      href='#/galaxy/ru'
                      media='go_fly_first.png'
                      name='RU'/>

          <Destination description='日本互联网星域'
                      href='#/galaxy/jp'
                      media='composer_fly_first.png'
                      name='JP'/>
